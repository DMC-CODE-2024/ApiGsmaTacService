...
public class Alert {
    ...
    public void raiseAnAlert( String alertUrl , final String alertId, final String alertMessage, final String alertProcess, final int userId) {
        ...
        try {
            ...
            logger.info("Alert to be send to url : {} , and  Request:{}  ", alertUrl, request);
...
class AlertDto {
    ...
    public String toString() {
        return new StringJoiner(", ", AlertDto.class.getSimpleName() + "[", "]")
                .add("alertId='" + alertId + "'")
                .add("alertMessage='" + alertMessage + "'")
                .add("alertProcess='" + alertProcess + "'")
                .add("userId='" + userId + "'")
                .toString();
    }
}
